	...
	<div class="product-wrap-inner">
		...
		<div class="product-hover">
			...
			<div class="product-buttons">
				...
				<a href="#" data-product-id="<?php echo esc_attr( $product->id ); ?>" class="quick-look-link button"><i class="fa fa-search"></i><span><?php _e( 'Quick Look', MTS_THEME_TEXTDOMAIN );?></span></a>
